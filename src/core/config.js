...
function readConfig() {
  ...
  return {
    ...
    discoverUserIds: readBoolEnv("CYBERBOSS_DISCOVER_USER_IDS"),
    ...
    enableProjectTools: readBoolEnv("CYBERBOSS_ENABLE_PROJECT_TOOLS"),
    ...
    weixinOperationsFile: readTextEnv("CYBERBOSS_OPERATIONS_FILE")
